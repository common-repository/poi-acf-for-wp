...
class POI_ACF_WC_Products extends POI_ACF_Location {
	...
	protected function initialize() {
		$this->slug = 'product_pages';
		$this->name = __( 'All Products', 'poi-acf-wp' );		
		$this->group_slug = 'products';
		$this->priority = 30;
		...
		add_action( 'wp_footer', array( &$this, 'add_fields' ), 100 );
	...
	public function save_form() {
		...
		$post_id = sanitize_poi_acf_data($_POST['post_id']);
